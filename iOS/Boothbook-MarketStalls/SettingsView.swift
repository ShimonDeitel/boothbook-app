...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Boothbook - Market Stalls Pro") {
                if purchases.isPro {
            ...
            Section("About") {
                Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/boothbook-app/privacy.html")!)
                Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/boothbook-app/terms.html")!)
                Text("Version 1.0")
